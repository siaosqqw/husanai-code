// Husanai Code: allow HUSANAI_API_KEY as alias for ANTHROPIC_API_KEY
if (process.env.HUSANAI_API_KEY && !process.env.ANTHROPIC_API_KEY) {
    process.env.ANTHROPIC_API_KEY = process.env.HUSANAI_API_KEY;
}
...
async function main(): Promise<void> {
    ...
    if (
        ...
        console.log(`${MACRO.VERSION} (Husanai Code)`);
        return;
    }
