...
function ElicitationFormDialog({
  ...
  useRegisterOverlay('elicitation', undefined);
  useNotifyAfterTimeout('Husanai Code needs your input', 'elicitation_dialog');
...
function ElicitationURLDialog({
  ...
  useNotifyAfterTimeout('Husanai Code needs your input', 'elicitation_url_dialog');
